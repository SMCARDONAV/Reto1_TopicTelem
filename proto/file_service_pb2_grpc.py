...
class FileServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DummyDownload = channel.unary_unary(
                '/fileservice.FileService/DummyDownload',
                ...
                _registered_method=True)
        self.DummyUpload = channel.unary_unary(
                '/fileservice.FileService/DummyUpload',
...
def add_FileServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DummyUpload': grpc.unary_unary_rpc_method_handler(
                    servicer.DummyUpload,
